(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */ __webpack_exports__["default"] = ("<!-- <div *ngFor=\"let error of errors\">\n  <p>{{ error.path }}</p>\n  <p>{{ error.message }}</p>\n</div>\n\n<div>\n  Name (required): <input type=\"text\" [(ngModel)]=\"newWitch.name\"><br>\n  Broom: <input type=\"text\" [(ngModel)]=\"newWitch.broom\"><br>\n  Coven (required): <input type=\"text\" [(ngModel)]=\"newWitch.coven\"><br>\n  <input (click)=\"submitWitch()\" type=\"submit\" value=\"New Witch\">\n</div>\n\n\n<div *ngFor=\"let witch of witches\">\n  <p>name: {{ witch.name }}</p>\n  <p>broom: {{ witch.broom }}</p>\n  <p>coven: {{ witch.coven }}</p>\n  <button (click)=\"deleteWitch(witch._id)\">Delete {{ witch.name }}!</button>\n</div> -->\n\n<button [routerLink]=\"['/home']\">Home</button>\n<button [routerLink]=\"['/create']\">Create</button>\n<router-outlet></router-outlet>");
            /***/ 
        }),
        ...
        /***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/witch/witch.component.html": 
        /*!**********************************************************************************!*\
          !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/witch/witch.component.html ***!
          \**********************************************************************************/
        /*! exports provided: default */
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<p>witch works!</p>\n");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _witch_witch_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./witch/witch.component */ "./src/app/witch/witch.component.ts");
            var routes = [
                ...
                { path: 'witch/:id', component: _witch_witch_component__WEBPACK_IMPORTED_MODULE_5__["WitchComponent"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.deleteWitch = function (id) {
                    var _this = this;
                    var observable = this.http.deleteById(id);
                    observable.subscribe(function (data) {
                        _this.getAllWitches();
                    });
                };
                AppComponent.prototype.getAllWitches = function () {
                    var _this = this;
                    var observable = this.http.getAll();
                    observable.subscribe(function (data) {
                        _this.witches = data;
                    });
                };
                AppComponent.prototype.submitWitch = function () {
                    var _this = this;
                    // tslint:disable-next-line:no-debugger
                    debugger;
                    var observable = this.http.createWitch(this.newWitch);
                    observable.subscribe(function (data) {
                ...
                AppComponent.prototype.errorHelper = function (errorMessage) {
                    var errorArr = [];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _witch_witch_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./witch/witch.component */ "./src/app/witch/witch.component.ts");
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                    declarations: [
                        ...
                        _witch_witch_component__WEBPACK_IMPORTED_MODULE_10__["WitchComponent"]
                    ],
                    imports: [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateComponent = /** @class */ (function () {
                ...
                CreateComponent.prototype.submitWitch = function () {
                    var _this = this;
                    var observable = this.http.createWitch(this.newWitch);
                    observable.subscribe(function (data) {
                        if (data.message === 'fail') {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IndexComponent = /** @class */ (function () {
                ...
                IndexComponent.prototype.getAllWitches = function () {
                    var _this = this;
                    var observable = this.http.getAll();
                    observable.subscribe(function (data) {
                        _this.witches = data;
        ...
        /***/ "./src/app/witch/witch.component.css": 
        /*!*******************************************!*\
          !*** ./src/app/witch/witch.component.css ***!
          \*******************************************/
        /*! exports provided: default */
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3dpdGNoL3dpdGNoLmNvbXBvbmVudC5jc3MifQ== */");
            /***/ 
        }),
        /***/ "./src/app/witch/witch.component.ts": 
        /*!******************************************!*\
          !*** ./src/app/witch/witch.component.ts ***!
          \******************************************/
        /*! exports provided: WitchComponent */
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WitchComponent", function () { return WitchComponent; });
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var WitchComponent = /** @class */ (function () {
                function WitchComponent() {
                }
                WitchComponent.prototype.ngOnInit = function () {
                };
                return WitchComponent;
            }());
            WitchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
                    selector: 'app-witch',
                    template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./witch.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/witch/witch.component.html")).default,
                    styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./witch.component.css */ "./src/app/witch/witch.component.css")).default]
                })
            ], WitchComponent);
            /***/ 
        }),
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! /Users/brendanstanton/Desktop/demos/new-witches/witches-boilerplate/public/src/main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
